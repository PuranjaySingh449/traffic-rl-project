...
from rl.evaluate_apa_dqn import evaluate_apa_dqn_once
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        set_seed(seed)
        out = evaluate_apa_dqn_once(seed, scenario)
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        b = evaluate_apa_dqn_once(seed, scenario)
        p = evaluate_apa_dqn_once(seed + 100, scenario)
...
print("\n✅ APA-DQN FULL evaluation complete")