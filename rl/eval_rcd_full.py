...
from rl.evaluate_rcd_dqn import evaluate_rcd_dqn_once
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        set_seed(seed)
        out = evaluate_rcd_dqn_once(seed, scenario)
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        b = evaluate_rcd_dqn_once(seed, scenario)
        p = evaluate_rcd_dqn_once(seed + 100, scenario)
...
print("\n✅ RCD-DQN FULL evaluation complete")