...
from rl.evaluate_hea import evaluate_hea_once
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        set_seed(seed)
        out = evaluate_hea_once(seed, scenario)
...
for scenario in SCENARIOS:
    ...
    for seed in SCENARIO_SEEDS[scenario]:
        ...
        b = evaluate_hea_once(seed, scenario)
        p = evaluate_hea_once(seed + 100, scenario)
...
for metric in ["emergency", "normal", "queue"]:
    ...
    plt.title(f"{MODEL_NAME.upper()} {metric}")
